...
public class DebugImageItemAdapter extends BaseAdapter {
    private final Context context;
    private final LayoutInflater inflater;
    private final ArrayList<ImageItem> items;
    private final int thumbColor;

    public DebugImageItemAdapter(Context context, ImageAdapter imageAdapter) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.itemType.setText(getString(R.string.image_type_value,ImageItem.BANNER_ITEM==item.imageType?ImageItem.BANNER_VALUE:ImageItem.LIST_VALUE));
        ...
        holder.thumbView.setItemCount(item.imageItems.size());
        holder.thumbView.setItemType(item.imageType);
