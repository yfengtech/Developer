...
class HierarchyLayout(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.HierarchyLayout).apply {
            setHorizontalSpacing(getDimension(R.styleable.HierarchyLayout_hl_horizontalSpacing,0f))
            setVerticalSpacing(getDimension(R.styleable.HierarchyLayout_hl_verticalSpacing,0f))
            setConnectLineColor(getColor(R.styleable.HierarchyLayout_hl_connectLineColor,Color.WHITE))
            setConnectLineStrokeWidth(getDimension(R.styleable.HierarchyLayout_hl_connectLineStrokeWidth,0f))
            setConnectLineCornerPathEffect(getDimension(R.styleable.HierarchyLayout_hl_connectLineCornerPathEffect,0f))
            setConnectLineEffectSize(getDimension(R.styleable.HierarchyLayout_hl_connectLineEffectSize,0f))
            setPreViewWidth(getDimension(R.styleable.HierarchyLayout_hl_previewWidth,0f))
            setHierarchyMaxScale(getFloat(R.styleable.HierarchyLayout_hl_hierarchyMaxScale,2f))
            setHierarchyMinScale(getFloat(R.styleable.HierarchyLayout_hl_hierarchyMinScale,0.6f))
            setHasFixSize(getBoolean(R.styleable.HierarchyLayout_hl_setHasFixedSize,true))
            recycle()
        }
    }
    ...
    inner class ViewFlinger:Runnable{
        ...
        fun postOnAnimation() {
            ...
            ViewCompat.postOnAnimation(this@HierarchyLayout, this)
        }
    }
