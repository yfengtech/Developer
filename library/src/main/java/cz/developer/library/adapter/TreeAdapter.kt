 ...
 */
abstract class TreeAdapter<E>(context: Context, protected val rootNode: TreeNode<E>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
     ...
     * @param position
     */
    abstract fun onBindViewHolder(holder: RecyclerView.ViewHolder, node: TreeNode<E>, e: E, viewType: Int, position: Int)
     ...
     * @param expand
     */
    protected open fun onNodeExpand(node: TreeNode<E>, holder: RecyclerView.ViewHolder, expand: Boolean) {}
    ...
    fun setOnNodeLoadCallback(callback:(TreeAdapter.TreeNode<E>)->Unit){
